...
function printFormEvent($idEvent, $dbh)
{
    ...
    <div><p>Evénemment : <input type="int" required name='EventTitle' value='$event->title' disabled="disabled"/></p></div>
    <div class="row"><div class="col-md-6"><p>Nom d'utilisateur : <input type="text"  value='$login' disabled="disabled" required name="login"/></p></div>
    <div class="col-md-6"><p> Niveau : 
    ...
    <div ><p class="w3-center">Mot de passe : <input type="password" name="mdp" required name='mdp' /></p></div>
