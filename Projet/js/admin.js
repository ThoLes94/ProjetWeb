...
function dr(d) {
    return '<div class="  mx-auto my-auto w3-round w3-card w3-center" id="descrip">' +
        ...
        '<p>Heure de début : <input id="formstart" type="time" name="start" value=' + d.start + ' required /></p>' +
        '</div>' +
        '<div class="col-sm-6">' +
        '<p>Heure de fin : <input id="formend" type="time" name="end" value=' + d.end + ' required /></p>' +
        '</div>' +
